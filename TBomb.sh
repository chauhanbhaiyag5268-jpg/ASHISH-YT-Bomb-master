...
banner() {
    ...
    echo -e "\e[1;32m           Instagram: https://www.instagram.com/_op_ashish_yt__?igsh=cWlmMGR6Z3B6NWw="
    echo -e "\e[4;32m   YouTube: https://whatsapp.com/channel/0029Vb6UgF47z4km21AOzK24"
    echo " "
